...
cfg_orderinfo = {
	...
	pricerang: [ //当价格处于定义范围之外或act为空时停止交易
		...
		{min:90, max:102, act:'buy', amount:600, pspace:0.05, gspace: 0.1501},
		{min:102, max:104, act:'buy', amount:500, pspace:0.05, gspace: 0.1501},
		{min:102, max:104, act:'sell', amount:100, pspace:0.05, gspace: 0.1501},
		{min:104, max:106, act:'buy', amount:400, pspace:0.05, gspace: 0.1501},
		{min:104, max:106, act:'sell', amount:200, pspace:0.05, gspace: 0.1501},
		{min:106, max:112, act:'sellbuy', amount:300, pspace:0.05, gspace: 0.1501},
		{min:112, max:114, act:'buy', amount:200, pspace:0.05, gspace: 0.1501},
		{min:112, max:114, act:'sell', amount:400, pspace:0.05, gspace: 0.1501},
		{min:114, max:116, act:'buy', amount:100, pspace:0.05, gspace: 0.1501},
		{min:114, max:116, act:'sell', amount:500, pspace:0.05, gspace: 0.1501},
		{min:116, max:130, act:'sell', amount:600, pspace:0.05, gspace: 0.1501},
		]
};
